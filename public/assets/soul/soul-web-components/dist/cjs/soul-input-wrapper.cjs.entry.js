...
const SoulInputWrapper = class {
  ...
  render() {
    return (index.h(index.Host, { "aria-label": this.label }, index.h("div", { id: this.instanceId, class: {
      ...
      } }, this.renderLabel(), index.h("div", { class: "soul-input-wrapper__control" }, this.renderTooltip(), this.renderSearchIcon(), index.h("slot", { onSlotchange: this.onInputSlotChange.bind(this), ref: el => this.inputSlot = el }), this.renderInputOverlays()), this.renderStatusMessage(), this.renderHelpText(), this.renderAction())));
  }
  initializeInput() {
  ...
  get shouldRenderStatusMessage() {
    return !this.isReadonly && ((this.isStatusValid || (this.invalidStyle && this.invalid)) && utils.isNotEmpty(this.statusMessage));
  }
  ...
  onKeyDown(event) {
    if (event.key === Keymap.Keymap.ESC) {
  ...
  renderLabel() {
    return (this.label || this.additionalLabel) ?
      index.h("div", { class: "soul-input-wrapper__label" }, index.h("label", { onClick: this.focusInput.bind(this) }, this.label, this.renderAdditionalLabel())) : '';
  }
  renderAdditionalLabel() {
    return this.additionalLabel ?
      index.h("span", { class: "soul-input-wrapper__additional-label" }, this.additionalLabel) : '';
  }
  renderTooltip() {
    return this.shouldRenderTooltip ?
      index.h("soul-tooltip", { text: this.shouldRenderStatusMessage ? this.statusMessage : this.helpText, status: this.status ? this.status : (this.invalid && this.invalidStyle) ? 'critical' : undefined, position: this.tooltipPosition, ref: el => this.tooltipElement = el }) : '';
  }
  renderSearchIcon() {
    return this.isSearchType ? index.h("soul-icon", { name: "search", size: "s", class: "soul-input-wrapper__search-icon" }) : '';
  }
  renderInputOverlays() {
    var _a;
  ...
  renderPasswordVisibilityToggle() {
    return !this.isReadonly && this.isPasswordType ?
      index.h("button", { class: "soul-input-wrapper__password-toggle soul-button soul-button--ghost soul-button--no-space soul-button--icon-only", onClick: this.onPasswordVisibilityToggle.bind(this) }, index.h("div", { class: "soul-button__icon" }, index.h("soul-icon", { name: this.isPasswordRevealed ? 'hide' : 'show', size: "s" }))) : '';
  }
  renderStatusIndicator() {
    return this.shouldRenderStatusIndicator ?
      index.h("soul-indicator", { size: "s", type: this.status === 'warning' && !this.invalid ? 'warning' : 'critical' }) : '';
  }
  renderCalendarIcon() {
    return !this.isReadonly && this.shouldRenderCustomIcon ?
      index.h("button", { class: " soul-button soul-button--ghost soul-button--no-space soul-button--icon-only", onClick: this.onDateTimeIconClick.bind(this) }, index.h("div", { class: "soul-button__icon" }, index.h("soul-icon", { size: "m", name: this.inputType === 'time' ? 'time' : 'calendar' })))
      : '';
  }
  renderClearButton() {
    return this.shouldRenderClearButton ?
      index.h("button", { class: "soul-input-wrapper__clear soul-button soul-button--ghost soul-button--no-space soul-button--icon-only", onClick: this.onClearButtonClick.bind(this), onBlur: this.setClearButtonVisibility.bind(this) }, index.h("div", { class: "soul-button__icon" }, index.h("soul-icon", { name: "close", size: "s", color: "reduced" }))) : '';
  }
  renderStatusMessage() {
    return this.shouldRenderStatusMessage ?
      index.h("div", { class: "soul-input-wrapper__status-message" }, this.statusMessage) : '';
  }
  renderHelpText() {
    return !this.isReadonly && this.helpText ?
      index.h("div", { class: "soul-input-wrapper__help" }, this.helpText) : '';
  }
  renderAction() {
    return !this.isReadonly && this.hasSlottedAction() ?
      index.h("div", { class: "soul-input-wrapper__action" }, index.h("slot", { name: "action" })) : '';
  }
  get hostElement() { return index.getElement(this); }
};
let inputWrapperId = 0;
SoulInputWrapper.style = soulInputWrapperCss;

exports.soul_input_wrapper = SoulInputWrapper;

//# sourceMappingURL=soul-input-wrapper.cjs.entry.js.map