...
const SoulMarkdownContent = class {
  constructor(hostRef) {
    ...
    this.soulMarkdownConverted = index.createEvent(this, "soulMarkdownConverted", 7);
    this.url = undefined;
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      }, innerHTML: utils.isDefined(this.convertedValue) ? this.convertedValue : '' })));
  }
  updateInnerHTML() {
    ...
    else if (utils.isNotEmpty(this.value)) {
...
exports.soul_markdown_content = SoulMarkdownContent;

//# sourceMappingURL=soul-markdown-content.cjs.entry.js.map