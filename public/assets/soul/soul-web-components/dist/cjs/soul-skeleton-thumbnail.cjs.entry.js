...
const SoulSkeletonThumbnail = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: `soul-skeleton-thumbnail ${this.shape === 'circle' ? 'soul-skeleton-thumbnail--circle' : 'soul-skeleton-thumbnail--square'}` })));
  }
...
exports.soul_skeleton_thumbnail = SoulSkeletonThumbnail;

//# sourceMappingURL=soul-skeleton-thumbnail.cjs.entry.js.map