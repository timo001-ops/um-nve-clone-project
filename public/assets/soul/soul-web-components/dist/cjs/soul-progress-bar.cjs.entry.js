...
const ProgressHelper = require('./ProgressHelper-7ff04a1a.js');
...
const SoulProgressBar = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.supportedStatuses = ['positive', 'warning', 'critical'];
    this.progressHelper = new ProgressHelper.ProgressHelper();
  ...
  render() {
    ...
    return (index.h(index.Host, { role: "progressbar", "aria-valuemin": this.range.min, "aria-valuemax": this.range.max, "aria-valuenow": this.progress, "aria-label": label, title: this.hideLabel ? label : '' }, index.h("div", { class: {
      ...
      } }, index.h("div", { class: "soul-progress-bar__track" }, index.h("div", { class: "soul-progress-bar__fill", style: { width: `${progressPercentage}%` } })), this.hasLabel(label) ?
      index.h("div", { class: "soul-progress-bar__content" }, utils.isDefined(this.status) && this.statusHelper.isValidStatus(this.supportedStatuses, this.status) ?
        index.h("div", { class: "soul-sign  soul-sign--regular soul-sign--inline" }, index.h("span", { class: "soul-sign__icon" }, index.h("soul-indicator", { size: "s", type: this.status })), index.h("span", { class: "soul-sign__text" }, index.h("span", { class: {
        ...
        index.h("span", { class: "soul-label soul-label--reduced h-truncate" }, label)) : '')));
  }
  hasLabel(label) {
    return !this.hideLabel && utils.isNotEmpty(label);
  }
...
SoulProgressBar.style = soulProgressBarCss;

exports.soul_progress_bar = SoulProgressBar;

//# sourceMappingURL=soul-progress-bar.cjs.entry.js.map