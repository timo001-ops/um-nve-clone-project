...
const SoulBenefitModal = class {
  constructor(hostRef) {
    ...
    this.soulClose = index.createEvent(this, "soulClose", 7);
  ...
  render() {
    return (index.h("dialog", { class: "soul-benefit-modal", onClose: () => this.emitCloseEvent(), ref: el => this.dialog = el }, index.h("div", { class: "soul-grid soul-grid--vertical" }, this.closeButton ?
      index.h("div", { class: "soul-benefit-modal__close" }, index.h("button", { onClick: () => {
          this.close();
        }, class: "soul-button soul-button--default soul-button--compact soul-button--icon-only" }, index.h("span", { class: "soul-button__icon" }, index.h("span", { class: "a-icon a-icon--close" })))) :
      '', index.h("div", { class: "soul-benefit-modal__media soul-grid-item-auto-span" }, index.h("slot", { name: "media" })), utils.isNotNull(this.heading) || utils.isNotNull(this.description) ?
      index.h("header", { class: "soul-benefit-modal__header soul-grid-item-auto-span" }, utils.isNotNull(this.heading) ?
        index.h("div", { class: "soul-benefit-modal__header-title" }, index.h("h1", { class: "soul-heading soul-heading--h4" }, this.heading)) :
        '', utils.isNotNull(this.description) ?
        index.h("div", { class: "soul-benefit-modal__header-description" }, index.h("p", null, this.description)) :
        '') :
      '', index.h("section", { class: "soul-benefit-modal__content soul-grid-item-fill-span  h-y-auto-scroll" }, index.h("slot", { name: "content" })), index.h("footer", { class: "soul-benefit-modal__buttons  soul-grid-item-auto-span soul-button-group  soul-button-group--no-wrap" }, index.h("slot", { name: "buttons" })))));
  }
  toggleDialog() {
    var _a;
...
exports.soul_benefit_modal = SoulBenefitModal;

//# sourceMappingURL=soul-benefit-modal.cjs.entry.js.map