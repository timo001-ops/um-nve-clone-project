...
class TooltipHelper {
  ...
  connect() {
    ...
    const updateCallback = () => {
      floatingUi_dom_esm.computePosition(this.reference, this.tooltip, {
        strategy: 'fixed',
        placement: this.tooltipPosition,
        middleware: [
          floatingUi_dom_esm.offset(1),
          floatingUi_dom_esm.flip({ elementContext: 'reference' }),
          floatingUi_dom_esm.flip({ boundary: document.body }),
          floatingUi_dom_esm.hide({ elementContext: 'reference' }),
        ]
    ...
    this.stopAutoUpdate = floatingUi_dom_esm.autoUpdate(this.reference, this.tooltip, updateCallback);
  }
  disconnect() {
...
const SoulTooltipComponent = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { 'soul-tooltip': true, 'soul-tooltip--hidden': this.hideTooltip }, ref: el => this.tooltipElement = el, role: "tooltip" }, this.text)));
  }
  get hideTooltip() {
    return (!utils.isDefined(this.triggerId) && !utils.isDefined(this.triggerElement)) || (utils.isEmptyString(this.text) || !utils.isDefined(this.text));
  }
  initializeTooltipHelper() {
    var _a;
    const triggerElement = this.getTriggerElement();
    (_a = this.tooltipHelper) === null || _a === void 0 ? void 0 : _a.disconnect();
    if (utils.isDefined(triggerElement)) {
  ...
  getTriggerElement() {
    return utils.isDefined(this.triggerElement) ? this.triggerElement : document.getElementById(this.triggerId);
  }
...
exports.soul_tooltip = SoulTooltipComponent;

//# sourceMappingURL=soul-tooltip.cjs.entry.js.map