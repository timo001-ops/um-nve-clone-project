...
import { b as isNotNull } from './utils.js';
...
const SoulBenefitModal$1 = /*@__PURE__*/ proxyCustomElement(class SoulBenefitModal extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return soulBenefitModalCss; }
}, [4, "soul-benefit-modal", {
    "open": [1540],
    "closeWithEsc": [516, "close-with-esc"],
...
function defineCustomElement$1() {
  ...
  const components = ["soul-benefit-modal"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-benefit-modal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulBenefitModal$1);
      }
      break;
  } });
}
...
const SoulBenefitModal = SoulBenefitModal$1;
const defineCustomElement = defineCustomElement$1;

export { SoulBenefitModal, defineCustomElement };
