...
import { d as defineCustomElement$2 } from './soul-icon2.js';
import { d as defineCustomElement$1 } from './soul-indicator2.js';
...
const SoulAvatar = /*@__PURE__*/ proxyCustomElement(class SoulAvatar extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulAvatarCss; }
}, [1, "soul-avatar", {
    "type": [513],
    "size": [513],
    "status": [513],
    "imageUrl": [513, "image-url"],
    "icon": [513],
    "chars": [513],
    "name": [513],
    "additionalText": [513, "additional-text"],
    "thumbnailOnly": [516, "thumbnail-only"],
    "color": [520],
    "accessibilityLabel": [513, "accessibility-label"],
    "muted": [516],
...
function defineCustomElement() {
  ...
  const components = ["soul-avatar", "soul-icon", "soul-indicator"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-avatar":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulAvatar);
      }
      break;
    case "soul-icon":
      if (!customElements.get(tagName)) {
...
export { SoulAvatar as S, defineCustomElement as d };

//# sourceMappingURL=soul-avatar2.js.map