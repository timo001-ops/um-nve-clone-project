...
import { i as isDefined, d as isEmptyString } from './utils.js';
...
const SoulTooltipComponent = /*@__PURE__*/ proxyCustomElement(class SoulTooltipComponent extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulTooltipCss; }
}, [1, "soul-tooltip", {
    "position": [513],
    "status": [513],
    "triggerId": [513, "trigger-id"],
    "text": [513],
    "triggerElement": [16]
  }]);
function defineCustomElement() {
  ...
  const components = ["soul-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-tooltip":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulTooltipComponent);
      }
      break;
  } });
}
...
export { SoulTooltipComponent as S, autoUpdate as a, computePosition as c, defineCustomElement as d, flip as f, offset as o, size as s };
