...
const SoulOptionGroup$1 = /*@__PURE__*/ proxyCustomElement(class SoulOptionGroup extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulOptionGroupCss; }
}, [1, "soul-option-group", {
    "label": [513],
    "disabled": [516],
    "hidden": [516]
...
function defineCustomElement$1() {
  ...
  const components = ["soul-option-group"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-option-group":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulOptionGroup$1);
      }
      break;
  } });
}
...
const SoulOptionGroup = SoulOptionGroup$1;
const defineCustomElement = defineCustomElement$1;

export { SoulOptionGroup, defineCustomElement };
