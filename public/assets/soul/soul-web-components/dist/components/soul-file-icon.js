...
const SoulFileIcon$1 = /*@__PURE__*/ proxyCustomElement(class SoulFileIcon extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulFileIconCss; }
}, [1, "soul-file-icon", {
    "format": [513],
    "status": [513],
    "size": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["soul-file-icon", "soul-indicator"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-file-icon":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulFileIcon$1);
      }
      break;
    case "soul-indicator":
      if (!customElements.get(tagName)) {
...
const SoulFileIcon = SoulFileIcon$1;
const defineCustomElement = defineCustomElement$1;

export { SoulFileIcon, defineCustomElement };
