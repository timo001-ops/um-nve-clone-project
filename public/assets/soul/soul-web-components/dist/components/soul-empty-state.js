...
const SoulEmptyState$1 = /*@__PURE__*/ proxyCustomElement(class SoulEmptyState extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulEmptyStateCss; }
}, [1, "soul-empty-state", {
    "heading": [513],
    "text": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["soul-empty-state"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-empty-state":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulEmptyState$1);
      }
      break;
  } });
}
...
const SoulEmptyState = SoulEmptyState$1;
const defineCustomElement = defineCustomElement$1;

export { SoulEmptyState, defineCustomElement };
