...
import { a as isNotEmpty, i as isDefined } from './utils.js';
import { K as Keymap } from './Keymap.js';
import { d as defineCustomElement$4 } from './soul-icon2.js';
import { d as defineCustomElement$3 } from './soul-indicator2.js';
import { d as defineCustomElement$2 } from './soul-tooltip.component.js';
...
const SoulInputWrapper$1 = /*@__PURE__*/ proxyCustomElement(class SoulInputWrapper extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulInputWrapperCss; }
}, [1, "soul-input-wrapper", {
    "additionalLabel": [513, "additional-label"],
    "clearButton": [516, "clear-button"],
    "inputOnly": [516, "input-only"],
    "helpText": [513, "help-text"],
    "invalidStyle": [516, "invalid-style"],
    "label": [513],
    "status": [513],
...
function defineCustomElement$1() {
  ...
  const components = ["soul-input-wrapper", "soul-icon", "soul-indicator", "soul-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-input-wrapper":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulInputWrapper$1);
      }
      break;
    case "soul-icon":
      if (!customElements.get(tagName)) {
...
const SoulInputWrapper = SoulInputWrapper$1;
const defineCustomElement = defineCustomElement$1;

export { SoulInputWrapper, defineCustomElement };

//# sourceMappingURL=soul-input-wrapper.js.map