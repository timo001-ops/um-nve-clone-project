...
import { a as autoUpdate, c as computePosition, o as offset, f as flip, s as size, d as defineCustomElement$2 } from './soul-tooltip.component.js';
import { i as isDefined, a as isNotEmpty, e as isUndefined } from './utils.js';
import { i as isKeyboardKeyAction, K as Keymap } from './Keymap.js';
import { S as SelectHelper } from './SelectHelper.js';
...
const SoulSelect$1 = /*@__PURE__*/ proxyCustomElement(class SoulSelect extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return soulSelectCss; }
}, [1, "soul-select", {
    "additionalLabel": [513, "additional-label"],
    "disabled": [516],
    "disableSpaces": [516, "disable-spaces"],
    "helpText": [513, "help-text"],
    "inputOnly": [516, "input-only"],
    "label": [513],
    "maxHeight": [513, "max-height"],
    "noOptionsMessage": [513, "no-options-message"],
    "placeholder": [513],
    "searchable": [516],
    "stateless": [516],
    "status": [513],
    "statusMessage": [513, "status-message"],
    "tooltipPosition": [513, "tooltip-position"],
    "searchFunction": [16],
    "showEmptyOptionMessage": [32]
  }, [[0, "soulOptionChange", "onOptionChange"], [0, "soulOptionHover", "onOptionHover"], [0, "soulOptionClick", "onSoulClick"], [0, "soulOptionSelectChange", "onOptionSelectChange"]]]);
let selectId = 0;
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["soul-select", "soul-icon", "soul-tooltip"];
  components.forEach(tagName => { switch (tagName) {
    case "soul-select":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SoulSelect$1);
      }
      break;
    case "soul-icon":
      if (!customElements.get(tagName)) {
...
const SoulSelect = SoulSelect$1;
const defineCustomElement = defineCustomElement$1;

export { SoulSelect, defineCustomElement };
